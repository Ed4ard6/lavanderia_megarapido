...
<div class="caja_facturas_admi">
    <div class="prueba_factura">
        ...
        <input class="input_right"  style="width: 165px ;" type="date" name="fecha_recibido" id="fecha_recibido" min="<?php echo $mes_min_print; ?>" max="<?php echo $mes; ?>" required><br><br><br>
        
        <label class="label" for="fecha_entrega">Fecha de entrega</label>
        <input class="input_right" style="width: 165px ;" type="date" name="fecha_entrega" id="fecha_entrega" min="<?php echo $fecha; ?>" max="<?php echo $mes; ?>" required><br><br>
        <br><br>
